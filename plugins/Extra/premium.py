...
async def plan(client, message):
    ...
    btn = [[
        ...
        InlineKeyboardButton("⌯ ᴄʜᴇᴄᴋ ᴀʟʟ ᴘʟᴀɴs ⌯", callback_data='free')],[InlineKeyboardButton("⌯ ᴄʟᴏꜱᴇ ⌯", callback_data="close_data")
    ]]
    await message.reply_photo(photo="https://envs.sh/B3G.jpg/IMG20250912710.jpg", caption=script.PREPLANS_TXT.format(message.from_user.mention), reply_markup=InlineKeyboardMarkup(btn))
